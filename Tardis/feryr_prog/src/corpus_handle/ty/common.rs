...
macro_rules! common_attr_getter {
    () => {
        #[inline(always)]
        pub fn id(&self) -> crate::corpus_handle::ty::TypeId {
            self.comm.id()
        }
        ...
        #[inline(always)]
        pub fn comm(&self) -> &crate::corpus_handle::ty::common::CommonInfo {
            &self.comm
        }
    };
}
...
macro_rules! extra_attr_getter {
    () => {
        #[inline(always)]
        pub fn bin_fmt(&self) -> crate::corpus_handle::ty::BinaryFormat {
            crate::corpus_handle::ty::BinaryFormat::Native
        }
    };
}
