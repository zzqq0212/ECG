...
use crate::corpus_handle::value::Value;
pub use buffer::*;
pub use common::*;
pub use float::*;
// pub use char::*;
...
pub use self::char::{CharFormat, CharType, CharTypeBuilder};
    ...
    ($func: ident( $($arg_name: ident : $arg_ty: ty),* ) $(-> $ret:ty)?) => {
        pub fn $func(&self,  $($arg_name: $arg_ty)*) $(-> $ret)?{
                match &self.inner {
                    ...
                    TypeKindInner::FloatType(inner) => inner.$func($($arg_name)*),
                    TypeKindInner::CharType(inner) => inner.$func($($arg_name)*),
...
impl Type {
    ...
    as_kind!(as_float, checked_as_float, FloatType);

    as_kind!(as_char, checked_as_char, CharType);
...
impl Display for Type {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.inner {
            ...
            TypeKindInner::FloatType(inner) => inner.fmt(f),
            TypeKindInner::CharType(inner) => inner.fmt(f),
...
impl TypeKindInner {
    pub fn kind(&self) -> TypeKind {
        ...
        match self {
            ...
            Self::IntType(_) => Int,
            Self::FloatType(_) => Float,
            Self::CharType(_) => Char,
