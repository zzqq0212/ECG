//! Prog parse.
use super::mutation::fixup;
use super::prog::{Call, CallBuilder, Prog};
use super::syscall::Syscall;
use super::target::Target;
use super::value::{
    DataValue, GroupValue, IntegerValue, PtrValue, ResValue, UnionValue, Value,
    ENCODING_ADDR_BASE,
};
use crate::corpus_handle::ty::{Dir, Type, TypeKind, TypeKind::*};
use pest::{Parser, Span};
use std::fmt;

#[derive(Parser)]
#[grammar = "corpus_handle/parse/prog_syntax.pest"]
...
//         addr = max_mem - size;
//     }
//     Ok(VmaValue::new(ty.id(), dir, addr, size, target.os().to_string()).into())
// }
